...
export const FLAVOR_THEMES: Theme[] = [
  ...
  },
  {
    ...
    accent2: "#B0D4E8",
    card: "#FFFFFF",
    cardBorder: "rgba(212,184,184,0.3)",
    myBubble: "#F0F8FF",
    herCard: "#FFF5F5",
    phoneShell: "#5F7A8C",
    phoneScreen: "#FFF5F5",
...
export const DARK_THEMES: Theme[] = [
  {
    ...
    accent2: "#5F6368",
    card: "#1A1F26",
    cardBorder: "rgba(138,180,248,0.18)",
    myBubble: "#2A3340",
    herCard: "#1A1F26",
    phoneShell: "#000000",
    phoneScreen: "#0F1419",
    bgGradient: "radial-gradient(circle at 20% 20%, rgba(138,180,248,0.1) 0%, transparent 55%), radial-gradient(circle at 80% 80%, rgba(95,99,104,0.15) 0%, transparent 55%)",
  },
  {
    id: "dark-forest",
    name: "深林夜色",
    ...
    phoneShell: "#000000",
    phoneScreen: "#0D1810",
    bgGradient: "radial-gradient(circle at 25% 25%, rgba(124,179,66,0.12) 0%, transparent 55%), radial-gradient(circle at 75% 75%, rgba(85,139,47,0.18) 0%, transparent 55%)",
  },
  {
    id: "dark-rose",
    name: "暗夜玫瑰",
    ...
    accent2: "#9C4A6E",
    card: "#241820",
    cardBorder: "rgba(232,112,154,0.22)",
    myBubble: "#322028",
    herCard: "#241820",
    phoneShell: "#000000",
    phoneScreen: "#1A0F14",
    bgGradient: "radial-gradient(circle at 20% 20%, rgba(232,112,154,0.15) 0%, transparent 55%), radial-gradient(circle at 80% 80%, rgba(156,74,110,0.18) 0%, transparent 55%)",
  },
  {
    id: "dark-amethyst",
    name: "紫水晶",
    ...
    accent2: "#6B4A9C",
    card: "#1F1830",
    cardBorder: "rgba(176,143,216,0.22)",
    myBubble: "#2A2040",
    herCard: "#1F1830",
    phoneShell: "#000000",
    phoneScreen: "#15101F",
    bgGradient: "radial-gradient(circle at 25% 20%, rgba(176,143,216,0.18) 0%, transparent 55%), radial-gradient(circle at 75% 80%, rgba(107,74,156,0.2) 0%, transparent 55%)",
  },
  {
    id: "dark-coffee",
    name: "深夜咖啡",
    ...
    accent2: "#8B5A3C",
    card: "#241C16",
    cardBorder: "rgba(200,149,106,0.22)",
    myBubble: "#322820",
    herCard: "#241C16",
    phoneShell: "#000000",
    phoneScreen: "#1A1410",
    bgGradient: "radial-gradient(circle at 20% 20%, rgba(200,149,106,0.15) 0%, transparent 55%), radial-gradient(circle at 80% 80%, rgba(139,90,60,0.2) 0%, transparent 55%)",
  },
  {
    id: "dark-mono",
    name: "纯黑",
    ...
    phoneShell: "#000000",
    phoneScreen: "#000000",
    bgGradient: "radial-gradient(circle at 30% 20%, rgba(255,255,255,0.04) 0%, transparent 50%)",
  },
];

// ============ 新增浅色主题 ============
export const LIGHT_EXTRA_THEMES: Theme[] = [
  {
    id: "light-snow",
    name: "初雪",
    group: "rich",
    ...
    accent2: "#81A4CD",
    card: "#FFFFFF",
    cardBorder: "rgba(62,124,177,0.15)",
    myBubble: "#DBE9F5",
    herCard: "#F5FAFE",
    phoneShell: "#1A2B3C",
    phoneScreen: "#F8FBFD",
    bgGradient: "radial-gradient(circle at 20% 20%, rgba(62,124,177,0.1) 0%, transparent 55%), radial-gradient(circle at 80% 80%, rgba(129,164,205,0.15) 0%, transparent 55%)",
  },
  {
    id: "light-cream",
    name: "奶油",
    ...
    accent2: "#E8C896",
    card: "#FFFFFE",
    cardBorder: "rgba(201,160,99,0.2)",
    myBubble: "#F0E5C8",
    herCard: "#FFFDF5",
    phoneShell: "#3D2F1A",
    phoneScreen: "#FFFDF5",
    bgGradient: "radial-gradient(circle at 25% 25%, rgba(201,160,99,0.12) 0%, transparent 55%), radial-gradient(circle at 75% 75%, rgba(232,200,150,0.18) 0%, transparent 55%)",
  },
  {
    id: "light-sage",
    name: "鼠尾草",
    ...
    accent2: "#9CB89A",
    card: "#F8FBF6",
    cardBorder: "rgba(91,130,96,0.2)",
    myBubble: "#C5D8C0",
    herCard: "#F0F5EC",
    phoneShell: "#1F3A22",
    phoneScreen: "#F0F4EE",
    bgGradient: "radial-gradient(circle at 20% 20%, rgba(91,130,96,0.12) 0%, transparent 55%), radial-gradient(circle at 80% 80%, rgba(156,184,154,0.15) 0%, transparent 55%)",
  },
  {
    id: "light-blush",
    name: "晨曦",
    ...
    accent2: "#F0B5A8",
    card: "#FFFCFA",
    cardBorder: "rgba(212,117,106,0.2)",
    myBubble: "#F5D0C5",
    herCard: "#FFF8F5",
    phoneShell: "#3A1F18",
    phoneScreen: "#FFF8F5",
    bgGradient: "radial-gradient(circle at 20% 20%, rgba(212,117,106,0.15) 0%, transparent 55%), radial-gradient(circle at 80% 80%, rgba(240,181,168,0.18) 0%, transparent 55%)",
  },
];

export const ALL_THEMES: Theme[] = [...FLAVOR_THEMES, ...SIMPLE_THEMES, ...RICH_THEMES, ...LIGHT_EXTRA_THEMES, ...DARK_THEMES];
